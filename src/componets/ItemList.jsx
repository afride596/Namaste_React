    ...
    <div className="">
      {Data.map((e) => (
            ...
            <div className="flex flex-col  w-11/12  ">
              ...
              <span className="font-medium">
                ...
                {(e?.card?.info?.price
                  ...
                  : e?.card?.info?.defaultPrice / 100).toFixed()}
              </span>
          ...
          <div className="w-3/12 relative flex justify-center">
            ...
            />
            <button className="absolute  -bottom-2 cursor-pointer left-[50px] border flex justify-center items-center text-[#0cff51] bg-[#ffff] font-semibold rounded-md shadow-lg px-6 py-1">ADD</button>
          </div>
          </div>
